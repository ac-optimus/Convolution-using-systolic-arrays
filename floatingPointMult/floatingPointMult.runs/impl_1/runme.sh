...
HD_PWD='D:/es203/floatingPointMult/floatingPointMult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log floatingPntMult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source floatingPntMult.tcl -notrace
