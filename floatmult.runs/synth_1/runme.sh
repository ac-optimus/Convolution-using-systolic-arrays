...
HD_PWD='C:/Users/nisar/floatmult/floatmult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit4.tcl
